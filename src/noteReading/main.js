...
// Exercise-specific: accidentals toggle
...
// Exercise-specific: octave toggle
document.getElementById('octave-row').addEventListener('click', exercise.toggleOctave);
...
document.getElementById('start-btn').addEventListener('click', () => {
  ...
  lastConfig = { clef, questionLimit, includeAccidentals, onComplete: showSummary };
  showScreen('game');
...
const showOctaveRow = () => { document.getElementById('octave-row').style.display = ''; };
connectMidi(true, onMidi, showOctaveRow);
document.querySelector('.connect-link').addEventListener('click', () => connectMidi(false, onMidi, showOctaveRow));
